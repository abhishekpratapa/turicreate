...
std::shared_ptr<MLModelWrapper> boosted_trees_regression::export_to_coreml(const std::string& filename) {
  ...
  return this->_export_xgboost_model(filename, false, false, context);
}
...
std::shared_ptr<MLModelWrapper> boosted_trees_classifier::export_to_coreml(const std::string& filename) {
  ...
  return this->_export_xgboost_model(filename, true, false, context);
}
