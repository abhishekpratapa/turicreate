...
std::shared_ptr<MLModelWrapper> random_forest_regression::export_to_coreml(const std::string& filename) {
...
std::shared_ptr<MLModelWrapper> random_forest_classifier::export_to_coreml(const std::string& filename) {
